...
## Install the composer and google SDK
...
Add a new file called googgleConf.php
```php
...
call this line below on the button that will redirect user to google login
```php

echo "<a href='".$client->createAuthUrl()."'>Google Login</a>";
```
and add this code to the redirect page
```php
